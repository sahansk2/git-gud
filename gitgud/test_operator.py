...
def test_level_progress(file_operator, progress_data, level):
    assert file_operator.level_progress(level) in {
...
def test_update_progress_file(file_operator, progress_data, level):
    ...
    assert file_operator.level_progress(level) == "value"
    assert file_operator.level_progress(level.next_level) == "unvisited"
